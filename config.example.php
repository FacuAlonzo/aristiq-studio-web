...
/* =============================================
   ...
   Buzón Titan (email de Hostinger):  host smtp.titan.email · puerto 465 · SSL
   Hostinger Email (no Titan):        host smtp.hostinger.com · puerto 465 · SSL
   ============================================= */
return [
    'smtp_host'   => 'smtp.titan.email',     // servidor SMTP de tu proveedor de correo
